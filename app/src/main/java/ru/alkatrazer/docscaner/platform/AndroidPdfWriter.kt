...
import ru.alkatrazer.docscaner.BuildConfig
import ru.alkatrazer.docscaner.data.PdfWriter
import ru.alkatrazer.docscaner.domain.OcrService
import ru.alkatrazer.docscaner.domain.PageToExport
...
class AndroidPdfWriter(val ocrService: OcrService, val assets: AssetManager) : PdfWriter {
    ...
    override suspend fun writePdfFromJpegs(
        ...
        doc.documentInformation.creator = "DocSScaner ${BuildConfig.VERSION_NAME}"
        doc.use { document ->
