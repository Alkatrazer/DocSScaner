 ...
 */
package ru.alkatrazer.docscaner.ui.screens.about
...
private const val FAIRSCAN_REPOSITORY_URL = "https://github.com/pynicolas/FairScan"
...
fun AboutContent(
    ...
    Column(
        ...
        Text(
            stringResource(R.string.based_on_fairscan),
            ...
            modifier = Modifier.clickable {
                onStartActivity(
                    Intent(Intent.ACTION_VIEW, FAIRSCAN_REPOSITORY_URL.toUri())
                )
            },
        )
