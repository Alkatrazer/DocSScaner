 ...
 */
package ru.alkatrazer.docscaner.ui.screens.export
...
import ru.alkatrazer.docscaner.THUMBNAIL_SIZE_DP
import ru.alkatrazer.docscaner.ui.Navigation
import ru.alkatrazer.docscaner.ui.components.AppOverflowMenu
import ru.alkatrazer.docscaner.ui.components.BackButton
import ru.alkatrazer.docscaner.ui.components.MainActionButton
import ru.alkatrazer.docscaner.ui.components.NewDocumentDialog
import ru.alkatrazer.docscaner.ui.components.isLandscape
...
import ru.alkatrazer.docscaner.ui.screens.settings.ExportFormat.PDF
...
fun ExportScreen(
    ...
    Scaffold(
        ...
        if (!isLandscape(LocalConfiguration.current)) {
            Column(
                modifier = containerModifier.fillMaxSize().padding(vertical = 12.dp),
