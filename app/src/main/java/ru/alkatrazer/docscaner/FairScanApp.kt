...
import ru.alkatrazer.docscaner.data.FileManager
import ru.alkatrazer.docscaner.data.LogRepository
import ru.alkatrazer.docscaner.data.OcrLanguageRepository
import ru.alkatrazer.docscaner.domain.ImageSegmentationService
import ru.alkatrazer.docscaner.domain.OcrService
import ru.alkatrazer.docscaner.platform.AndroidImageLoader
import ru.alkatrazer.docscaner.platform.AndroidPdfWriter
import ru.alkatrazer.docscaner.ui.screens.camera.CameraViewModel
import ru.alkatrazer.docscaner.ui.screens.settings.SettingsRepository
